...
ScenarioResult.successful = function (hints) {
    return new ScenarioResult(true, TerminationStatus.Completion, hints);
};
...
function ScenarioExecutionException(result, message) {
    this.name = 'ScenarioExecutionException';
    this.message = message;
    this.result = result;
    this.stack = (new Error()).stack;
}

ScenarioExecutionException.prototype = Object.create(Error);
