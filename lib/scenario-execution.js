...
function ScenarioExecution(scenario, context) {
    ...
    var completionHook = new CompletablePromise(),
        ...
        scenarioTimeout = timeout(new Promise(function () {}), scenario.timeouts.self, function (resolve, reject, e) {
    ...
    function log(level, message, parameters) {
        container.logger.log.call(container.logger, [level, message].concat(parameters));
    }
    ...
    function transitionTo(stage, id, hints) {
        ...
        state.transition.trigger.resolve();
    ...
    function handleTransitionResolve(transition, result) {
        ...
        if (arrivedAt.terminal) {
            ...
            terminate(transition.promise, result.hints || {});
            ...
            transitionTo(result.trigger.stage, result.trigger.id, result.trigger.hints);
        }
    }
    ...
    function terminate(trigger, hints) {
        ...
        Promise
            ...
            .then(function (v) {
                ...
                info('Termination sequence has completed abnormally: {}', e);
