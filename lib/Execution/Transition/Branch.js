...
function Branch (options) {
  ...
  function runHandler (handler, origin, hints, token) {
    ...
    var callback = callbackFactory(handler, origin, hints, token, localToken)
  ...
  function callbackFactory (handler, origin, hints, token) {
    return function (resolve, reject, error) {
      ...
      runHandler(handler.timeoutHandler, origin, hints, token, error)
  ...
  function run (origin, hints, token) {
    ...
    runHandler(options.handler, origin, hints, token)
      .then(function (value) {
