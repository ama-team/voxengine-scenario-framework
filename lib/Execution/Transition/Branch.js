 ...
 * @property {IHandler} timeoutHandler
...
function Branch (options) {
  ...
  var loggerName = 'ama-team.voxengine-scenario-framework.execution.transition.execution-branch'
  ...
  function runHandler (origin, hints, token) {
    ...
    var callback = function (resolve, reject, error) {
      ...
      runTimeoutHandler(origin, hints, token, error).then(resolve, reject)
    }
  ...
  function run (origin, hints, token) {
    ...
    logger.info('Running execution branch')
